...
class Publications extends Component {
  ...
  render() {
    ...
    let readableTime
    let lastSearchedAll =  this.props.publication.reduce((a, b) => (a.last_searched > b.last_searched ? a : b)).last_searched;
    ...
    return(
      <>
        <Paper style={{maxWidth:'40%',margin:'20px',padding:'10px',backgroundColor:'#f3f3f3'}}>
          ...
          <Typography variant='h6'>
            Searches Remaining: <Typography variant='body1' component="span"></Typography>
          </Typography>
          <Typography variant='h6'>
